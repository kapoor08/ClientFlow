...
export const API_SECTIONS: ApiSection[] = [
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description:
          "Creates a new API key. The full key is only returned once at creation.",
        body: [
          {
            name: "name",
            type: "string",
          ...
          },
          {
            ...
            required: false,
            description: "Optional expiry date for the key.",
          },
        ],
      ...
      },
      {
        ...
        description:
          "Revokes an API key, preventing it from being used for further requests.",
        body: [
          {
            name: "action",
            type: '"revoke"',
            required: true,
            description: 'Must be "revoke".',
          },
        ],
  ...
  },
  {
    ...
    title: "Clients",
    description:
      "Manage clients (companies or individuals) within your organization.",
    endpoints: [
      {
        method: "GET",
        path: "/api/clients",
        ...
        description:
          "Returns a paginated list of clients for the authenticated organization.",
        params: [
          {
            name: "q",
            type: "string",
  ...
  },
  {
    ...
    title: "Projects",
    description:
      "Create and manage projects linked to clients within your organization.",
    endpoints: [
      {
        method: "GET",
        path: "/api/projects",
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "ID of an existing client to associate.",
          },
          {
            name: "status",
            type: "string",
      ...
      },
      {
        ...
        summary: "Get project",
        description:
          "Retrieves full details for a specific project including tasks.",
        responseExample: `{\n  "id": "prj_01j...",\n  "name": "New Website",\n  "tasks": [...]\n}`,
      },
      {
        method: "PATCH",
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "ID of the project to associate.",
          },
          {
            name: "status",
            type: "string",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description:
          "Registers a new webhook endpoint for one or more event types.",
        body: [
          {
            name: "name",
            type: "string",
          ...
          },
          {
            ...
            type: "string (URL)",
            required: true,
            description: "The HTTPS endpoint to send events to.",
          },
          {
            name: "events",
            type: "string[]",
