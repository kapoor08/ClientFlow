...
export default function PlansPage({ isExpired, plans }: Props) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      <div className="mb-10 text-center">
        <div className="mb-4 flex items-center justify-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary">
            <span className="font-display text-sm font-bold text-primary-foreground">CF</span>
          </div>
          <span className="font-display text-xl font-semibold text-foreground">ClientFlow</span>
        </div>
      ...
      {plans.length === 0 ? (
        <div className="w-full max-w-2xl rounded-xl border border-border bg-card p-8 text-center text-sm text-muted-foreground">
